...
(function (ru) {
    ...
    (function (bvb) {
        var Dungeons = (function () {
            ...
            ;
            Dungeons.rarityIDs_$LI$ = function () { if (Dungeons.rarityIDs == null)
                Dungeons.rarityIDs = (new java.util.ArrayList()); return Dungeons.rarityIDs; };
            ;
            Dungeons.rarityNames_$LI$ = function () { if (Dungeons.rarityNames == null)
                Dungeons.rarityNames = (new java.util.ArrayList()); return Dungeons.rarityNames; };
            ;
            Dungeons.init = function () {
                Dungeons.initDungeons();
                Dungeons.initRarity();
            };
            /*private*/ Dungeons.initRarity = function () {
            ...
            /*private*/ Dungeons.initDungeons = function () {
                Dungeons.add(1, "Picnic Grove");
                Dungeons.add(2, "Goblin House");
                Dungeons.add(3, "Spell Academy");
                Dungeons.add(4, "Skittery Park");
                Dungeons.add(5, "Slimeville");
                Dungeons.add(11, "Weird Woody Woods");
                Dungeons.add(12, "Fort Goblin");
                Dungeons.add(13, "Sorcery School");
                Dungeons.add(14, "Beegarden");
                Dungeons.add(15, "Slimurai Hamlet");
                Dungeons.add(16, "Bonefield");
                Dungeons.add(17, "Pumpkin Patch");
                Dungeons.add(21, "Gold wood of [Capital]");
                Dungeons.add(22, "MtGoldenest of [Capital]");
                Dungeons.add(23, "TycoonTower of [Capital]");
                Dungeons.add(24, "Gold Slime Tower");
                Dungeons.add(25, "Bistro Porkpork");
                Dungeons.add(26, "Rare 2 Woods");
                Dungeons.add(27, "Rare 2 Sewer");
                Dungeons.add(28, "Rare 2 Mansion");
                Dungeons.add(29, "Rare 2 Ruins");
                Dungeons.add(30, "Pignite Farm");
                Dungeons.add(31, "Pignoon Paradise");
                Dungeons.add(32, "Chez Pharaoh(Fragments)");
                Dungeons.add(33, "Samurai Dojo");
                Dungeons.add(34, "Sliamond Tower ");
                Dungeons.add(35, "Garbi Desert");
                Dungeons.add(36, "Twisty Misty Woods");
                Dungeons.add(37, "Poison City Sewer");
                Dungeons.add(38, "Morning Porkpark");
                Dungeons.add(39, "House of Nanjaro(weekends)");
                Dungeons.add(40, "Maestro Nobiyo\'s Farm");
                Dungeons.add(41, "Holy Thelomon Castle");
                Dungeons.add(42, "Fort Supopon");
                Dungeons.add(44, "King Sliamond Tower");
                Dungeons.add(45, "Danmaku Castle");
                Dungeons.add(47, "Onion Hotel");
                Dungeons.add(48, "Heaven\'s Door");
                Dungeons.add(51, "Ghost House");
                Dungeons.add(52, "Flame Cave");
                Dungeons.add(53, "Mimictown");
                Dungeons.add(54, "Royal Rat Trove");
                Dungeons.add(55, "Boneboat");
                Dungeons.add(56, "Aja\'s Tower");
                Dungeons.add(57, "Santa Flophouse");
                Dungeons.add(58, "Snowbytown Square");
                Dungeons.add(59, "Raid Tower");
                Dungeons.add(60, "Lavender Avenue Shop");
                Dungeons.add(61, "King Ghost\'s Palace");
                Dungeons.add(62, "Fire Golem Cave");
                Dungeons.add(63, "Mimiqueen\'s Villa");
                Dungeons.add(65, "Cap\'n Bone\'s Big Boat");
                Dungeons.add(67, "Mysterious Hard Labor Zone");
                Dungeons.add(70, "Mamayan Ruins");
                Dungeons.add(71, "Heck Yeah High School");
                Dungeons.add(72, "Turtle Bath(weekends)");
                Dungeons.add(73, "Crocodile Eighteen");
                Dungeons.add(80, "Wacky Hanami Party");
                Dungeons.add(81, "Toilet Island");
                Dungeons.add(91, "Dragon Castle");
                Dungeons.add(92, "Asparaguster\'s Ranch ");
                Dungeons.add(93, "Legendary Dragonkeep");
                Dungeons.add(99, "Porto Pepperoni Warehouse #3");
            };
            Dungeons.add = function (id, name) {
                if (id === 0 || (name.length === 0)) {
                    return;
                }
                Dungeons.dungeonIDs_$LI$().add(id * 100);
                Dungeons.dungeonNames_$LI$().add("(" + id.toString() + ")" + name);
            };
            return Dungeons;
        }());
            ...
            (function (plugin) {
                var DungeonSpell = (function () {
                    ...
                    DungeonSpell.getDungeonName = function (dungeonID) {
                        if (dungeonID >= 100) {
                            dungeonID = (((dungeonID / 100 | 0)) | 0) * 100;
                        }
                        for (var i = 0; i < ru.bvb.Dungeons.dungeonIDs_$LI$().size(); i++) {
...
ru.bvb.Dungeons.rarityNames_$LI$();
ru.bvb.Dungeons.rarityIDs_$LI$();
