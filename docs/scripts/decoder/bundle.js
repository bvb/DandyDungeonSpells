    ...
    (function (bvb) {
        var Dungeons = (function () {
            ...
            Dungeons.init = function () {
                Dungeons.add(0, "TycoonTower of Tokyo");
                Dungeons.add(2302, "TycoonTower of NYC");
                Dungeons.add(0, "TycoonTower of Cairo");
                Dungeons.add(0, "TycoonTower of Paris");
                Dungeons.add(0, "TycoonTower of London");
                Dungeons.add(0, "MtGoldenest of Tokyo");
                Dungeons.add(0, "MtGoldenest of NYC");
                Dungeons.add(2202, "MtGoldenest of Cairo");
                Dungeons.add(0, "MtGoldenest of Paris");
                Dungeons.add(0, "MtGoldenest of London");
                Dungeons.add(0, "Gold wood of Tokyo");
                Dungeons.add(0, "Gold wood of NYC");
                Dungeons.add(0, "Gold wood of Cairo");
                Dungeons.add(0, "Gold wood of Paris");
                Dungeons.add(0, "Gold wood of London");
                Dungeons.add(0, "Gold Slime Tower");
                Dungeons.add(0, "Sliamond Tower");
                Dungeons.add(4405, "King Sliamond Tower");
                Dungeons.add(101, "Picnic Grove");
                Dungeons.add(201, "Goblin House");
                Dungeons.add(0, "Slimeville");
                Dungeons.add(401, "Skittery Park");
                Dungeons.add(0, "Spell Academy");
                Dungeons.add(5302, "Mimictown");
                Dungeons.add(0, "Boneboat");
                Dungeons.add(0, "Ghost House");
                Dungeons.add(0, "Flame Cave");
                Dungeons.add(0, "Samurai Dojo");
                Dungeons.add(0, "House of Nanjaro");
                Dungeons.add(0, "Weekends only");
                Dungeons.add(5403, "Royal Rat Trove");
                Dungeons.add(5603, "Aja\'s Tower");
                Dungeons.add(0, "Dragon Castle");
                Dungeons.add(0, "Fort Goblin");
                Dungeons.add(0, "Weird Woody Woods");
                Dungeons.add(1503, "Slimurai Hamlet");
                Dungeons.add(0, "Beegarden");
                Dungeons.add(0, "Sorcery School");
                Dungeons.add(0, "Previously aka Spell Academy");
                Dungeons.add(0, "King Ghost\'s Palace");
                Dungeons.add(0, "Mimiqueen\'s Villa");
                Dungeons.add(0, "Asparaguster\'s Ranch");
                ...
                Dungeons.add(0, "Morning Porkpark");
                Dungeons.add(3103, "Pignoon Paradise");
                Dungeons.add(0, "Bistro Porkpork");
                Dungeons.add(0, "Pignite Farm");
                Dungeons.add(1603, "Bonefield");
                Dungeons.add(8103, "Toilet Island");
                Dungeons.add(0, "Wacky Hanami Party");
                Dungeons.add(0, "Snowbytown Square");
        ...
        Dungeons.dungeonOne = "U99V Y8A7 1H33 3SZY 9D35 F4E7";
        Dungeons.dungeonTwo = "3WVM WPBG 69R7 2BD4 54C1 DAA2";
        Dungeons.dungeonThree = "TC1X 6BJR HOEM N434 CT03 37CE";
        Dungeons.dungeonFour = "ECTE H1AS UUGW 89GY 6Y60 9931";
        Dungeons.dungeonFive = "VJFL KZLO 6X7T 45HP H227 B3C8";
        Dungeons.dungeonSix = "FM8YVST18B1HFA7U7QE02C2B";
...
(function (ru) {
    ...
    (function (bvb) {
        var Main = (function () {
            ...
            /*private*/ Main.generateSimpleRandom = function (paramLong) {
                return 42;
            };
            return Main;
        }());
